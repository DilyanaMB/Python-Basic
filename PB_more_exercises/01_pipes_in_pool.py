...
if total_litters <= volume:
    p1_filled_percent = p1_filled / total_litters * 100
    p2_filled_percent = p2_filled / total_litters * 100

    print(f"The pool is {total_filled_percent:.2f}% full. Pipe 1: {p1_filled_percent:.2f}%. Pipe 2:"
          f" {p2_filled_percent :.2f}%.")
else:
    print(f"For {hours:.2f} hours the pool overflows with {total_litters - volume:.2f} liters.")